...
class TodoCurrentViewFragment extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TodoCurrentViewFragment> createState() =>
      _TodoCurrentViewFragmentState();
}

class _TodoCurrentViewFragmentState
    extends ConsumerState<TodoCurrentViewFragment> {
  @override
        ...
        Expanded(
          ...
          child: SingleChildScrollView(
            ...
            child: TodoListFragment(
              ...
              onCategorySelected:
                  widget.viewIndex == 1 ? widget.onCategorySelected : null,
              selectedCategory:
                  widget.viewIndex == 1 ? widget.selectedCategory : null,
            ),
          ),
        ),
