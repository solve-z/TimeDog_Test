...
import 'package:timedog_test/common/constants/app_constants.dart';
import '../../features/todo/providers/todo_provider.dart';
import '../../features/todo/providers/category_order_provider.dart';
import '../../features/todo/models/vo_todo_item.dart';
...
class _TodoSelectionDialogState extends ConsumerState<TodoSelectionDialog> {
  ...
  List<TodoItemVo> _getFilteredTodos(List<TodoItemVo> todos, String filter) {
    ...
    final todayTodos =
        incompleteTodos
            .where((todo) => _isAppToday(todo.scheduledDate))
            .toList();
